...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 bg-light p-5 form-create2">
            <h2 class="mb-3 diplay-5 fs-4">Richieste Amministratore</h2>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 bg-light p-5 form-create2">
            <h2 class="mb-3 diplay-5 fs-4">Richieste di Revisore</h2>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 bg-light p-5 form-create2">
            <h2 class="mb-3 diplay-5 fs-4">Richieste di Articolista</h2>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 bg-light p-5 form-create2">
            <h2 class="mb-3 diplay-4 fs-4">I tags della piattaforma</h2>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 bg-light p-5 form-create2">
            <h2 class="mb-3 diplay-4 fs-4">Le categorie della piattaforma</h2>
